                    ...
                    <table>
                        ...
                        foreach($product_details[0]['quote_data'] as $product_detail) {
                            ...
                            <tr>
                                ...
                                <td class="total_price">
                                    <?php echo wc_price( $product_detail['sub_total'] );
                                    ?>
                                </td>
                            </tr>
							...
							$product_detail['sub_total'] ;
                            $sale_price = $product->get_price();
                            $gett = $product_detail['sub_total'];
                       ...
                       <tfoot>
                           <tr>
                               ...
                               <td><?php echo wc_price($gett) ; //wc_price($whole_quote_sub_total); ?> </td>
                           </tr>
                       </tfoot>
                   </table>
               </div>
